...
public class SearchTestUtil {
    ...
    static Passengers createPassengers(int adultCount, int childCount, int infantInLapCount, int infantInSeatCount, int seniorCount) {
    ...
    public static ScheduledSearch createScheduledSearchWithThreeDates() {
        Passengers passengers = createPassengers(1, 2, 3, 10, 2);
        return createScheduledSearchWithThreeDates(passengers);
    }

    static ScheduledSearch createScheduledSearchWithThreeDates(Passengers passengers) {
    ...
    static ScheduledSearch createScheduledSearch(List<LocalDate> dates, Passengers passengers) {
    ...
    static PassengersTO createPassengersTO(int adultCount, int childCount, int infantInLapCount, int infantInSeatCount, int seniorCount) {
    ...
    static SearchInputData createSearchInputDataWithThreeDates() {
        PassengersTO passengers = createPassengersTO(1, 2, 3, 10, 2);
        return createSearchInputDataWithThreeDates(passengers);
    }

    static SearchInputData createSearchInputDataWithThreeDates(PassengersTO passengers) {
    ...
    static SearchInputData createSearchInputData(LocalDate[] dates, PassengersTO passengers) {
    ...
    static FoundTrip createFoundTrip() {
    ...
    static List<Flight> createFlights(LocalDateTime[] datesTo, LocalDateTime[] datesFrom, int[] durations, String[][] airlineNames, String[][] stopCodes) {
    ...
    static Flight createFlight(LocalDateTime[] dates, int duration, String[] airlineName, String[] stopCode) {
    ...
    static void addAirline(String airlineName, Flight flight) {
    ...
    static void addStop(String code, Flight flight, LocalDateTime arrivalTime, LocalDateTime departureTime) {
    ...
    static void assertEqualFields(ImmutableSearchInputData immutableSearchInputData, ScheduledSearch scheduledSearch) {
    ...
    static void assertPassengersEqual(ImmutableSearchInputData immutableSearchInputData, ScheduledSearch scheduledSearch) {
    ...
    static void assertEqualFields(ImmutableSearchInputData immutableSearchInputData, SearchInputData searchInputData) {
    ...
    static void assertEqualFields(SearchResult result, FoundTrip foundTrip) {
